    ...
    <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-950 font-sans text-slate-100">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-white mb-1">Welcome to StockFlow</h2>
          <p className="text-sm text-slate-400 text-center">Enter your details to manage your store inventory & bills</p>
        </div>
